...
curl http://localhost:8080/api/admin/datasetfield/load -X POST --data-binary @data/metadatablocks/citation_zh.tsv -H "Content-type: text/tab-separated-values"
...
curl http://localhost:8080/api/admin/datasetfield/load -X POST --data-binary @data/metadatablocks/social_science_zh.tsv -H "Content-type: text/tab-separated-values"
