...
if(params.widget === 'iframe-register') {
    /*
     * Dataverse rigester
     */
    document.write('<iframe src="' + params.dvUrl + '/iframe-dataverseuser.xhtml?editMode=CREATE'
            + '&registerUserType=' + params.registerUserType
            + '&joinGroupId=' + params.joinGroupId
            + '" width="100%" height="' + params.heightPx 
            + '" style="padding:4px; border:0; background:url(' + params.dvUrl 
            + '/resources/images/ajax-loading.gif) no-repeat 50% 50%;"></iframe>');
}