 ...
 * @author luopc
 */
@FacesValidator("cn.edu.pku.lib.dataverse.validation.AdvanceBuiltinUserNotBlankValidator")
public class AdvanceBuiltinUserNotBlankValidator implements Validator{
