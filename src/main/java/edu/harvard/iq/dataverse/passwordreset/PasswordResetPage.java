...
public class PasswordResetPage implements java.io.Serializable {
    ...
    public String sendPasswordResetLink() {
        ...
        try {
            ...
            if(passwordResetInitResponse.isEmailFound()){
                ...
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Email not validated: can't find the user", ""));
