...
public class DatasetFieldConstant implements java.io.Serializable  {
    ...
    public final static String authorZh =  "author_zh";
    ...
    public final static String authorNameZh ="authorName_zh";
    public final static String authorAffiliation = "authorAffiliation";
    public final static String authorAffiliationZh = "authorAffiliation_zh";
    ...
    public final static String publicationZh = "publication_zh";
    public final static String publicationCitationZh = "publicationCitation_zh";
    public final static String publicationIDNumberZh = "publicationIDNumber_zh";
    public final static String publicationIDTypeZh = "publicationIDType_zh";
    public final static String publicationURLZh = "publicationURL_zh";
    public final static String titleZh = "title_zh";
    public final static String keywordZh = "keyword_zh";
    public final static String keywordValueZh="keywordValue_zh";
    public final static String descriptionZh = "dsDescription_zh";
    public final static String descriptionTextZh = "dsDescriptionValue_zh";
    public final static String notesTextZh="notesText_zh";
    public final static String subjectZh="subject_zh";
    public final static String depositorZh="depositor_zh";
    public final static String dateOfDepositZh="dateOfDeposit_zh";
    public final static String datasetContactZh = "datasetContact_zh";
    public final static String datasetContactNameZh = "datasetContactName_zh";
    public final static String datasetContactAffiliationZh = "datasetContactAffiliation_zh";
    public final static String datasetContactEmailZh = "datasetContactEmail_zh";
    /*
    ...
    public static String getTitleZh() {
        return titleZh;
    }

    public static String getDescriptionZh() {
        return descriptionZh;
    }

    public static String getDescriptionTextZh() {
        return descriptionTextZh;
    }
}
