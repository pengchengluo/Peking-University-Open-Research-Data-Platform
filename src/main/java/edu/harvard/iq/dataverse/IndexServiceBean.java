...
public class IndexServiceBean {
    ...
    public Future<String> indexDataverse(Dataverse dataverse) {
        ...
        solrInputDocument.addField(SearchFields.NAME_ZH, dataverse.getNameZh());
        ...
        if (dataverse.isReleased()) {
            ...
            solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT, convertToFriendlyDate(dataverse.getPublicationDate(),null));
            solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT_ZH, convertToFriendlyDate(dataverse.getPublicationDate(),Locale.SIMPLIFIED_CHINESE));
        } else {
            ...
            solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT, convertToFriendlyDate(dataverse.getCreateDate(),null));
            solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT_ZH, convertToFriendlyDate(dataverse.getCreateDate(),Locale.SIMPLIFIED_CHINESE));
        }
...
//        }
        ...
        solrInputDocument.addField(SearchFields.DESCRIPTION_ZH, StringUtil.html2text(dataverse.getDescriptionZh()));
        solrInputDocument.addField(SearchFields.DATAVERSE_DESCRIPTION, StringUtil.html2text(dataverse.getDescription()));
        solrInputDocument.addField(SearchFields.DATAVERSE_DESCRIPTION_ZH, StringUtil.html2text(dataverse.getDescriptionZh()));
...
//            solrInputDocument.addField(SearchFields.CATEGORY, dataverse.getAffiliation());
        ...
        if(dataverse.getAffiliationZh() != null && !dataverse.getAffiliationZh().isEmpty()){
            solrInputDocument.addField(SearchFields.AFFILIATION_ZH, dataverse.getAffiliationZh());
            solrInputDocument.addField(SearchFields.DATAVERSE_AFFILIATION_ZH, dataverse.getAffiliationZh());
        }
        ...
        if (rootDataverse != null && !dataverse.equals(rootDataverse)) {
            ...
            if (dataverse.getOwner() != null) {
                ...
                solrInputDocument.addField(SearchFields.PARENT_NAME_ZH, dataverse.getOwner().getNameZh());
            }
        }
...
//                solrInputDocument.addField(SearchFields.PUBLICATION_STATUS, DEACCESSIONED_STRING);
        ...
        solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT, convertToFriendlyDate(datasetSortByDate,null));
        solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT_ZH, convertToFriendlyDate(datasetSortByDate,Locale.SIMPLIFIED_CHINESE));
...
//            solrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE, dataset.getPublicationDate());
        ...
        if (datasetVersion != null) {
            ...
            solrInputDocument.addField(SearchFields.DATASET_CITATION, datasetVersion.getCitation(true,null));
            solrInputDocument.addField(SearchFields.DATASET_CITATION_ZH, datasetVersion.getCitation(true,"zh"));
...
//                                    solrInputDocument.addField(solrFieldFacetable, Integer.parseInt(datasetFieldFlaggedAsDate));
                        ...
                        if (dsf.getDatasetFieldType().getName().equals("authorAffiliation")) {
                             ...
                             * of DatasetField.java
                             */
                            solrInputDocument.addField(SearchFields.AFFILIATION_ZH, dsf.getValuesWithoutNaValues());
...
//        solrInputDocument.addField(SearchFields.HOST_DATAVERSE, dataset.getOwner().getName());
        ...
        solrInputDocument.addField(SearchFields.PARENT_NAME_ZH, dataset.getOwner().getNameZh());
        ...
        if (datasetVersion != null) {
            ...
            for (FileMetadata fileMetadata : fileMetadatas) {
                ...
                if (indexThisMetadata) {
                    ...
                    datafileSolrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT, convertToFriendlyDate(fileSortByDate,null));
                    datafileSolrInputDocument.addField(SearchFields.RELEASE_OR_CREATE_DATE_SEARCHABLE_TEXT_ZH, convertToFriendlyDate(fileSortByDate,Locale.SIMPLIFIED_CHINESE));
...
//        return "indexed dataset " + dataset.getId() + " as " + solrDocId + "\nindexFilesResults for " + solrDocId + ":" + fileInfo.toString();
    ...
    public String convertToFriendlyDate(Date dateAsDate,Locale locale) {
        if (dateAsDate == null) {
            dateAsDate = new Date();
        }
