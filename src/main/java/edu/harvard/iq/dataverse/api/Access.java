...
import cn.edu.pku.lib.dataverse.util.UserAgent;
...
public class Access extends AbstractApiBean {
    ...
    public DownloadInstance datafile(@PathParam("fileId") Long fileId, @QueryParam("key") String apiToken, @Context UriInfo uriInfo, @Context HttpHeaders headers, @Context HttpServletRequest request, @Context HttpServletResponse response) /*throws NotFoundException, ServiceUnavailableException, PermissionDeniedException, AuthorizationRequiredException*/ {
        DataFile df = dataFileService.find(fileId);
        ...
        downloadInstance.setUserAgent(new UserAgent(request.getHeader("User-Agent")));
    ...
    */
    ...
    public DownloadInstance tabularDatafileMetadataPreprocessed(@PathParam("fileId") Long fileId, @QueryParam("key") String apiToken, @Context UriInfo uriInfo, @Context HttpHeaders headers, @Context HttpServletRequest request, @Context HttpServletResponse response) {
        uriInfo.getQueryParameters().clear();
        uriInfo.getQueryParameters().add("format", "prep");
        
        return datafile(fileId, apiToken, uriInfo, headers, request, response);
    }
